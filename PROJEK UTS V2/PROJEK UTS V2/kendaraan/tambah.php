...
<div class="content">
  ...
  <div class="card shadow-sm p-4">
    ...
    if (isset($_POST['simpan'])) {
        ...
        $koneksi->query("INSERT INTO kendaraan (merk, pemilik, nopol, thn_beli, deskripsi, jenis_kendaraan_id) 
                         VALUES ('$merk', '$pemilik', '$nopol', '$thn_beli', '$deskripsi', '$jenis_kendaraan_id')");
